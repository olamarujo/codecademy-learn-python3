# define a function to decrypt a message that needs the message and a keyword to be the key to encrypt
def vigenere_decode_func(message, keyword):
    ...
    for letter in message:
        ...
        if letter.isalpha() == True:
            ...
            # DECRYPTION: add indices, wrap around using modulo
        ...
        # if the caracter is not a letter
            ...
            my_msg_decrip += letter

    return my_msg_decrip

my_msg_crip = 'Vplxo. Z uv Fcorugf uwr w hieh pid o jprk nzwn roj!'
keyword = 'olamarujo'
print(vigenere_decode_func(my_msg_crip, keyword))